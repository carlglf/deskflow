...
static const OptionID kOptionModifierMapForShiftLeft = OPTION_CODE("MMSL");
static const OptionID kOptionModifierMapForShiftRight = OPTION_CODE("MMSR");
static const OptionID kOptionModifierMapForControlLeft = OPTION_CODE("MMCL");
static const OptionID kOptionModifierMapForControlRight = OPTION_CODE("MMCR");
static const OptionID kOptionModifierMapForAltLeft = OPTION_CODE("MMAL");
static const OptionID kOptionModifierMapForAltRight = OPTION_CODE("MMAR");
...
static const OptionID kOptionModifierMapForSuperLeft = OPTION_CODE("MMUL");
static const OptionID kOptionModifierMapForSuperRight = OPTION_CODE("MMUR");
static const OptionID kOptionModifierMapForAltGrKey = OPTION_CODE("MMGK");
